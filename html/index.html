...
<div>
    ...
    <ul class="kategori">
        <li><a href="#"><i class="fa fa-star" aria-hidden="true"></i>Top Trusted Suplier</a></li>
    ...
    <div class="List-product">
        ...
        <p>Have a big target in business?Join FastXPort to become a supplier that meets worldwide demand and is ready <br>to ship worldwide with a fast and safe guarantee</p>
        
        <button href="#">Join as Supplier</button>
    ...
    <div class="more">
    <p>FastXPort provides delivery services with various types of transportation according to the <br> capacity of your goods and we have a guarantee that the goods will arrive safely</p>
    <button href="#" class="more-button">More</button>
    </div>
